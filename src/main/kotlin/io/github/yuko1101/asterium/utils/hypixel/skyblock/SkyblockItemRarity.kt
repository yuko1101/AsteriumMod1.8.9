 ...
 * Link: https://github.com/Skytils/SkytilsMod/blob/e6fd3bf86cf98cb5b74221bf8a27cff38fcd0d40/src/main/kotlin/skytils/skytilsmod/utils/ItemRarity.kt
 *
 ...
 * @author SteveKunG
 */
enum class SkyblockItemRarity(val rarityName: String, val baseColor: ChatColor, val color: Color = baseColor.color!!) {
    ...
    companion object {
        private val VALUES = values().sortedBy { obj: SkyblockItemRarity -> obj.ordinal }.toMutableList()
    ...
    val nextRarity: SkyblockItemRarity
