 ...
 * Link: https://github.com/Skytils/SkytilsMod/blob/1.x/src/main/kotlin/skytils/skytilsmod/utils/ItemUtil.kt
 *
...
package io.github.yuko1101.asterium.utils.hypixel.skyblock

import io.github.yuko1101.asterium.utils.StringUtils.stripControlCodes
import io.github.yuko1101.asterium.utils.hypixel.skyblock.SkyblockItemRarity.Companion.RARITY_PATTERN
...
object SkyblockItemUtils {
     ...
     */
    fun getRarity(item: ItemStack?): SkyblockItemRarity {
        if (item == null || !item.hasTagCompound()) {
            return SkyblockItemRarity.NONE
        }
        ...
        for (i in (lore.tagCount() - 1) downTo 0) {
            ...
            if (rarityMatcher != null) {
                ...
                SkyblockItemRarity.values().find {
        ...
        if (petRarityMatcher != null) {
            val color = petRarityMatcher.groupValues.getOrNull(1) ?: return SkyblockItemRarity.NONE
            return SkyblockItemRarity.byBaseColor(color) ?: SkyblockItemRarity.NONE
        }
